  ...
  <header>
    ...
    <nav class="nav-extended teal">
      <div class="nav-wrapper">
        <a href="#" class="brand-logo center hide-on-small-only"><?= $title ?></a>
        <a href="#" class="brand-logo center hide-on-med-and-up"><img width="50" height="50" src="https://svn.apache.org/repos/asf/lucene.net/trunk/branding/logo/lucene-net-icon-512x256.png"></a>
      ...
      <div class="nav-wrapper teal">
        <div class="col s12" style="margin-left: 10px;">
          ...
          <a href="<?= base_url('layanan/makeuppesta') ?>" class="breadcrumb">Make Up Pesta</a>
        </div>
    ...
    <main> 
     <div class="fixed-action-btn">
      <a id="menu" class="btn-floating btn-large teal" href="<?= base_url('Ordering/addtocart/pesta') ?>">
    ...
    <div class="tap-target teal" data-target="menu">
      <div class="tap-target-content white-text">
        ...
        <p style="font-size: 11px;" class="hide-on-med-and-up">
          Anda dapat meng-order layanan make up pesta kami dengan menekan tombol bergambar keranjang yang ada di bawah ini. 
    ...
    <div class="container">
      ...
      <br>
      <h3 class="light center-align">MAKE UP PESTA</h3>
