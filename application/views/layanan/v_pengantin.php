  ...
  <header>
    ...
    <nav class="nav-extended teal">
      ...
      <div class="nav-wrapper teal">
        <div class="col s12" style="margin-left: 10px;">
          ...
          <a href="<?= base_url('layanan/makeuppengantin') ?>" class="breadcrumb">Make Up Pengantin</a>
        </div>
    ...
    <main> 
     <div class="fixed-action-btn">
      <a id="menu" class="btn-floating btn-large teal" href="<?= base_url('Ordering/addtocart/pengantin') ?>">
    ...
    <div class="tap-target teal" data-target="menu">
      <div class="tap-target-content white-text">
        ...
        <p style="font-size: 11px;" class="hide-on-med-and-up">
          Anda dapat meng-order layanan make up pengantin kami dengan menekan tombol bergambar keranjang yang ada di bawah ini. 
    ...
    <div class="container">
      ...
      <br>
      <h3 class="light center-align">MAKE UP PENGANTIN</h3>
